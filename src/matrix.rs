...
where
    T: Add<Output = T> + Copy + Mul<Output = T> + AddAssign + Default + Send + 'static,
{
    if a.col != b.row {
    ...
    //generate 4 threads which receive message and do dot product
    ...
    for i in 0..a.row {
        for j in 0..b.col {
            ...
            let col_data = b.data[j..]
                ...
                .step_by(b.col)
                .copied()
                .collect::<Vec<_>>(); // b.data[j..].step_by(b.col)
